    ...
    return (
        <div className=" flex flex-col sm:flex-row   mt-3 p-3 sm:mt-5 sm:p-5 " style={{color:"whitesmoke"}}>
            <div className="m-2 p-2 sm:mt-5 sm:p-5  sm:w-1/2 justify-center flex flex-col items-center">
                ...
                <div className="flex">
                    <a href="https://www.instagram.com/mauryapavan662/" className="m-2 text-2xl contact  transition duration-300 hover:scale-120 hover:-translate-y-1 "><FontAwesomeIcon icon={faInstagramSquare} /></a>
                    
                    <a href="www.linkedin.com/in/pawan-maurya-494455339" className="m-2 text-2xl contact  transition duration-300 hover:scale-120 hover:-translate-y-1 "><FontAwesomeIcon icon={faLinkedin} /></a>
                    <a href="https://github.com/mauryapavan?tab=repositories" className="m-2 text-2xl contact  transition duration-300 hover:scale-120 hover:-translate-y-1 "><FontAwesomeIcon icon={faGithub} /></a>
